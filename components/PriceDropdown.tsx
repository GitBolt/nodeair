    ...
    return (
        <div className="dropdown" style={{ height: menuHeight || "1" }} ref={dropdownRef}>
            ...
            <div className="menu">
                ...
                <Image src={Dollar}/> <h2> Subscription based</h2>
                </a>
            ...
            <div className="menu">
                ...
                <Image src={Invoice}/> <h2>One time payment</h2>
                </a>
